...
class PocitadloApp:
    ...
    def vytvor_zastupny_obrazok(self, farba):
        # ZVAČŠENÉ OBRÁZKY (250x250)
        img = tk.PhotoImage(width=250, height=250)
        img.put(farba, to=(0, 0, 249, 249))
        return img
    ...
    def otvorit_vyber_chyby(self, index_riadku):
        ...
        btn_container.pack(fill=tk.BOTH, expand=True, padx=30, pady=30)
        ...
        for i in range(3):
            ...
            f.grid(row=0, column=i, sticky="nsew", padx=15)
            
            cfg = SUB_TYPES[i]
            
            # Väčšie písmo na tlačidlách
