...
class PocitadloApp:
    def __init__(self, root):
        ...
        self.skontroluj_csv()
        self.vytvor_header()
        self.vytvor_rozhranie() # Tu sa vytvoria tlačidlá back_buttons
        self.aktualizuj_cas()
        
        self.root.update() 
        for i in range(self.pocet_riadkov):
            self.prekresli_bar(i)
            self.aktualizuj_tlacidlo_spat(i) # Tu sa volá funkcia, ktorá chýbala
    ...
    # --- AKTUALIZÁCIA TLAČIDLA SPÄŤ (Toto chýbalo!) ---
